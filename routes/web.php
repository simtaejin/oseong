...
Route::get('/dashboard/detail/{id}', [Dashboard::class, 'detail'])->name('detail')->middleware('auth')->middleware('myfavorites');
Route::post('/dashboard/store/', [Dashboard::class, 'store'])->name('store')->middleware('auth')->middleware('myfavorites');
